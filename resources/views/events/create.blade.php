                    ...
                    <form method="POST" action="{{ route('events.store') }}" class="space-y-6">
                            ...
                            <div>
                                ...
                                >
                                    @foreach (\App\Enums\EventStatus::cases() as $status)
                                        <option value="{{ $status->value }}" @selected(old('status', \App\Enums\EventStatus::OPEN->value) === $status->value)>
                                            {{ $status->label() }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="grid gap-6 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                <x-text-input id="parking_slots" name="parking_slots" type="number" min="1" class="mt-1 block w-full" :value="old('parking_slots')" />
                        ...
                        <div class="flex items-center gap-4">
                            <x-primary-button>Guardar evento</x-primary-button>
                        </div>
                    </form>
                </div>
            </div>
